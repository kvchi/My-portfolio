...
export default function progressBar() {
  return (
    <div className="z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
  <section className="my-4">
    <h2 className="text-2xl md:text-3xl font-bold mb-8 text-primary text-center md:text-left">
      Technologies I Work With
    </h2>

    <div className="grid  grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-x-8 gap-y-6 mx-auto">
