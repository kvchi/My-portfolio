        ...
        <div className="flex flex-col pt-4 md:pt-0 md:pl-8 lg:pl-14">
          {
            footerLinkData.map(el => <Link key={el.id} to={el.link}
                className='footer-link flex items-center text-green-200 text-base md:text-lg py-2 px-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-100'>
                    {el.icon}
